...
public class TranscribeMenuActivity extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.transcriber, menu);
        return true;
    }
        ...
        switch (item.getItemId()) {
            case R.id.stop:
                ...
                post(new Runnable() {
                    @Override
                    public void run() {
                        stopService(new Intent(TranscribeMenuActivity.this, TextService.class));
                    }
                });
                return true;
            default:
